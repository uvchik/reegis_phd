...
import numpy as np
import pandas as pd
from berlin_hp import electricity, heat
...
from my_reegis import regional_results, results
from oemof import solph
from oemof.tools import logger
from reegis import bmwi, coastdat
...
if __name__ == "__main__":
    ...
    # plot_all(show=True)
    plot_figure("4.14", save=True, show=True, path=p)
